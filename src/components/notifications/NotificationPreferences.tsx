...
const CATEGORIES: Category[] = [
  ...
  { id: "document",     label: "Documentos",     description: "Receitas e atestados disponíveis",       icon: FileText,   color: "text-amber-600 dark:text-amber-400", bg: "bg-amber-500/10",  defaultOn: true  },
